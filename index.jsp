...
<body id="page-top">
	...
	<nav id="sidebar-wrapper">
		<ul class="sidebar-nav">
			<li class="sidebar-brand"><a href="#page-top">한울 직교 수강생 작품</a></li>
	...
	<header class="masthead d-flex align-items-center">
		<div class="container px-4 px-lg-5 text-center">
			<h1 class="mb-1">Hanul student work</h1>
			<h3 class="mb-5">
				<em>Spring,Android ...</em>
			</h3>
			<a class="btn btn-primary btn-xl" href="#about">View </a>
		</div>
	</header>
	<!-- About-->
		...
		<div class="container px-4 px-lg-5 text-center">
			<div class="row gx-4 gx-lg-5 justify-content-center">
				<div class="col-lg-10">
					<h2>개발자 과정 모집중입니다</h2>
					<p class="lead mb-5">
						평소 컴퓨터에 관심이 많거나 프로그래밍이 재밌다면 바로 수강 신청해주세요. <a
							href="http://hanuledu.co.kr/">한울홈페이지</a> !
					</p>
					<a class="btn btn-dark btn-xl" href="#services">보러가기</a>
				</div>
			</div>
		</div>
	</section>
		...
		<div class="container px-3 px-lg-5">
			...
			<div class="row gx-3 gx-lg-5">
				<div class="col-lg-4 col-md-6 mb-5 mb-lg-0">
					...
					<p class="text-faded mb-0">안드로이드 기반의 모바일 개발!</p>
				</div>
				<div class="col-lg-4 col-md-6 mb-5 mb-lg-0">
					<span class="service-icon rounded-circle mx-auto mb-3"><i
						class="fa-brands fa-internet-explorer"></i></span>
					<h4>
						<strong>Spring</strong>
					</h4>
					<p class="text-faded mb-0">Spring 기반의 웹 개발</p>
				</div>
				<div class="col-lg-4 col-md-6 mb-5 mb-md-0">
					<span class="service-icon rounded-circle mx-auto mb-3"><i
						class="fa-solid fa-laptop-arrow-down"></i></span>
					<h4>
						<strong>IoT</strong>
					</h4>
					<p class="text-faded mb-0">Arduino & Raspberry를 이용한 개발</p>
				</div>
			...
			<div class="row gx-0">
				...
				<div class="col-lg-6">
					<a class="portfolio-item" href="#!">
						...
						</div> <img class="img-fluid" src="assets/img/portfolio/portfolio-22.jpg" alt="..." />
					</a>
				</div>
				<div class="col-lg-6">
					<a class="portfolio-item" href="#!">
						...
						</div> <img class="img-fluid" src="assets/img/portfolio/portfolio-33.jpg" alt="..." />
					</a>
				</div>
				<div class="col-lg-6">
					<a class="portfolio-item" href="#!">
						...
						</div> <img class="img-fluid" src="assets/img/portfolio/portfolio-44.jpg" alt="..." />
					</a>
				</div>
				<div class="col-lg-6">
					<a class="portfolio-item" href="#!">
						...
						</div> <img class="img-fluid" src="assets/img/portfolio/portfolio-55.jpg" alt="..." />
					</a>
				</div>
				<div class="col-lg-6">
					<a class="portfolio-item" href="#!">
						...
						</div> <img class="img-fluid" src="assets/img/portfolio/portfolio-66.jpg" alt="..." />
					</a>
				</div>
	...
	<div class="map" id="contact">
		<iframe
			src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1631.0602965936673!2d126.88691208567452!3d35.15361310545268!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x35718c095451ddab%3A0xb8207167890e32bb!2z7ZWc7Jq47KeB7JeF7KCE66y47ZWZ6rWQ!5e0!3m2!1sko!2skr!4v1649990046195!5m2!1sko!2skr"
	...
	<footer class="footer text-center">
		<div class="container px-4 px-lg-5">
			...
			<p class="text-muted small mb-0">한울직업전문학교 &copy; Kym Test Website
				2022</p>
		</div>
	</footer>
